...
delay_ms= 5;
window_Hz= 12;
Root_dAM_power_dir= ['D:\Dropbox\Pitts_files\Aravind_ExpAM\___manuscript\dAM_power_data\' sprintf('%.0fms_%.0fHz', delay_ms, window_Hz) filesep];
...
fig_name= [fig_dir 'Fig5_validate' sprintf('%.0fms_%.0fHz', delay_ms, window_Hz)];
if do_save_fig
...
%% print all Rsq 
figure(98)
plot([lin_mdl_human.Rsquared.Adjusted, lin_mdl_gerbil.Rsquared.Adjusted, lin_mdl_mice.Rsquared.Adjusted, ...
    lin_mdl_rat_vert.Rsquared.Adjusted, lin_mdl_rat_horz.Rsquared.Adjusted, lin_mdl_all.Rsquared.Adjusted,], 'd-');
ylim([0, 1]);
