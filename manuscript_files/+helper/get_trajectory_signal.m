...
function [fracSignal, filtSignal, sig_remod, sig_static_mod]= get_trajectory_signal(inSig, fs, freqTrajectory, filtParams)
...
filtSignal= sqrt(2)*filtfilt(d_lp, sig_demod_empirical);
